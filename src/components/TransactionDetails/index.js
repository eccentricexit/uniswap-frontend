...
import { isAddress, amountFormatter, computeMarginalPrice, computeRelativeMarginalPrice } from '../../utils'
import { useDebounce } from '../../hooks'

import question from '../../assets/images/question.svg'

import NewContextualInfo from '../../components/ContextualInfoNew'
import { SWAP_TYPE } from '../ExchangePage';
...
export default function TransactionDetails(props) {
  ...
  const renderTransactionDetails = () => {
    ...
    if (tokenReservesInput.eq(bigNumberify('0')) || tokenReservesOutput.eq(bigNumberify('0')))
      return marginalPriceDisplay

    if (tokenReservesInput && tokenReservesOutput && inputValueParsed && outputValueParsed)
      if (swapType === SWAP_TYPE.ETH_TO_TOKEN || swapType === SWAP_TYPE.TOKEN_TO_ETH) {
    ...
    if (!dependentDecimals || !independentDecimals) marginalPriceDisplay = <div>-</div>
